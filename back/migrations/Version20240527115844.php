 ...
 */
final class Version20240527115844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payement (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, contravention_id INT DEFAULT NULL, INDEX IDX_B20A7885A76ED395 (user_id), UNIQUE INDEX UNIQ_B20A7885C8213BEF (contravention_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
